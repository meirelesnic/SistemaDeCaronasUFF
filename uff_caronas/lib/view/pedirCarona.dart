...
class _PedirCaronaState extends State<PedirCarona> {
  ...
  Future<void> checkOrigemDestinoRota() async {
    if (origem && destino) {
      List<LatLng> result = await routeService.getRouteLatLng(origemCoord[0], origemCoord[1], destinoCoord[0], destinoCoord[1]);
      setState(() {
        route = result;
      });
    } else {
      ...
      body: Stack(
        children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.symmetric(vertical: screenSize.height * (8/800)),
                      child: Text('De',
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        width: double.infinity,
                        padding: EdgeInsets.symmetric(horizontal: screenSize.width * (28/360)),
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Data',
          ...
          Positioned(
            ...
            top: origemFocus.hasFocus ? screenSize.height * (145/800) : screenSize.height * (230/800),
            child: Container(
              color: Colors.white,
              child: SizedBox(
                width: screenSize.width * (254/360),
